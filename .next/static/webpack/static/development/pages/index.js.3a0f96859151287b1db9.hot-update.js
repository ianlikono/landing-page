...
})(["font-size:2rem;font-family:", ";color:", ";border-radius:0.2em;border:none;position:relative;background:transparent;display:block;margin:2em auto;padding:0.5em 0.25em;text-align:center;box-shadow:0 0 1em 0.25em rgba(0,0,0,0.2);&:active{border:none;}&:focus{border:none;background:red;}"], function (props) {
  return props.theme.fontFamilyPrimary;
}, function (props) {
...
//# sourceMappingURL=index.js.3a0f96859151287b1db9.hot-update.js.map