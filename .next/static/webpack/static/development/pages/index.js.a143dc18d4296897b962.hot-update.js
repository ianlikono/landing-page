...
})(["width:40rem;height:35rem;margin:0;padding:0;border:none;border-radius:0.5rem;background-color:", ";box-shadow:", ";display:flex;justify-content:center;align-items:center;"], function (props) {
  return props.theme.colorTextPrimary;
}, function (props) {
...
})(["font-size:2rem;font-family:", ";color:", ";border-radius:0.5rem;border:none;position:relative;background:transparent;display:block;margin:0;padding:0.5em 0.25em;text-align:center;box-shadow:0 0 1em 0.25em rgba(0,0,0,0.2);touch-action:manipulation;background-color:#fff;background-image:none;&:active{border:none;}&:focus{border:none;}"], function (props) {
  return props.theme.fontFamilyPrimary;
}, function (props) {
...
//# sourceMappingURL=index.js.a143dc18d4296897b962.hot-update.js.map