...
})(["font-size:2rem;font-family:", ";color:", ";border-radius:0.5rem;border:none;position:relative;background:transparent;display:block;margin:5rem;padding:0.5em 0.25em;text-align:center;box-shadow:0 0 1em 0.25em rgba(0,0,0,0.2);touch-action:manipulation;background-color:#fff;background-image:none;width:80%;&:active{border:none;}&:focus{border:none;outline:none !important;}"], function (props) {
  return props.theme.fontFamilyPrimary;
}, function (props) {
...
//# sourceMappingURL=index.js.83b3a14e640d20d0fe78.hot-update.js.map