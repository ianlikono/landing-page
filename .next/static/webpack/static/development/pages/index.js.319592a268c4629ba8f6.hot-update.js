...
})(["font-size:2rem;font-family:", ";color:", ";border-radius:0.5rem;border:none;position:relative;background:transparent;display:block;margin:2rem;padding:0.5em 0.25em;text-align:center;box-shadow:0 0 1em 0.25em rgba(0,0,0,0.2);touch-action:manipulation;background-color:#fff;background-image:none;width:80%;&:active{border:none;}&:focus{border:none;outline:none !important;}"], function (props) {
  return props.theme.fontFamilyPrimary;
}, function (props) {
...
//# sourceMappingURL=index.js.319592a268c4629ba8f6.hot-update.js.map