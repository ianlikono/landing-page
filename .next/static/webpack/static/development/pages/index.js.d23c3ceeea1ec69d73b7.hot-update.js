...
})(["font-size:2rem;font-family:", ";color:", ";border-radius:0.5rem;border:none;position:relative;background:transparent;display:block;margin:2rem;padding:0.5em 0.25em;text-align:center;touch-action:manipulation;background-color:#fff;background-image:none;width:80%;&:active{border:none;}&:focus{border:none;outline:none !important;}"], function (props) {
  return props.theme.fontFamilyPrimary;
}, function (props) {
...
//# sourceMappingURL=index.js.d23c3ceeea1ec69d73b7.hot-update.js.map